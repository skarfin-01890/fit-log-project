...
return (
  ...
  saveLater.map((exercise: IExercise) => (
	<div
	  key={exercise.id}
	...
	>
	  ...
	  <div className="flex shrink-0 items-center gap-4">
		...
		<button type="button" className="rounded-full border border-white/30 px-6 py-2.5 text-sm font-bold text-white transition hover:bg-white/10">
		  View Details
		</button>
		</Link>
